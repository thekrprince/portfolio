    ...
    <section className="flex flex-col p-8 bg-gray-300 dark:bg-stone-900 rounded-2xl">
      ...
      <div className="m-2">
        ...
        <p className="mt-1">
          ...
          ♥️ Frontend. Content Creator. Public Speaker. Technical Blogger. Tech
          Enthusiast.
        </p>
      </div>
      <div className="mx-2 mt-2 flex flex-wrap items-center gap-1 text-sm lg:text-base">
        ...
        <span className="flex mr-2 md:mr-4">
          ...
          <span className="ml-1">June 9th</span>
        </span>
        <span className="flex mr-2 md:mr-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="ml-1">Joined Jul 2023</span>
        </span>
      </div>
    </section>
  );
